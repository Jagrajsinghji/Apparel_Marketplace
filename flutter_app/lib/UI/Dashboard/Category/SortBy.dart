  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: GestureDetector(onTap: (){
        ...
        child: Scaffold(backgroundColor: Colors.black26,
          body: BackdropFilter(filter: ImageFilter.blur(sigmaX: 2,sigmaY: 2),
            child: Container(
              color: Colors.white,
              child: Padding(
                  ...
                  children: [
                    ...
                    ListTile(onTap: (){
                      ...
                      title: Text(
                        "What’s new",
                        style: TextStyle(
                          color:widget.sort==Sort.WhatsNew?Colors.white: Color(0xff969696),
                          fontSize: 14,
                        ),
                      ),
                    ),
                    ListTile(onTap: (){
                      ...
                      title: Text(
                        "Price - high to low",
                        style: TextStyle(
                          color:widget.sort==Sort.PriceHighToLow?Colors.white: Color(0xff969696),
                          fontSize: 14,
                        ),
                      ),
                    ),
                    ...
                    ListTile(onTap: (){
                      ...
                      title: Text(
                        "Price - low to high",
                        style: TextStyle(
                          color:widget.sort==Sort.PriceLowToHigh?Colors.white: Color(0xff969696),
                          fontSize: 14,
                        ),
                      ),
                    ),
                    ...
                    ListTile(onTap: (){
                      ...
                      title: Text(
                        "Popularity",
                        style: TextStyle(
                          color:widget.sort==Sort.Popularity?Colors.white: Color(0xff969696),
                          fontSize: 14,
                        ),
                      ),
                    ),
                    ...
                    ListTile(onTap: (){
                      ...
                      title: Text(
                        "Discount",
                        style: TextStyle(
                          color:widget.sort==Sort.Discount?Colors.white: Color(0xff969696),
                          fontSize: 14,
                        ),
                      ),
                    ),
                    ...
                    ListTile(onTap: (){
                      ...
                      title: Text(
                        "Customer rating",
                        style: TextStyle(
                          color:widget.sort==Sort.CustomerRating?Colors.white: Color(0xff969696),
                          fontSize: 14,
                        ),
                      ),
                    ),
