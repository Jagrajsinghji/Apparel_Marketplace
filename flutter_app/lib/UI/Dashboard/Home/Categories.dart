                ...
                itemBuilder: (c, i) {
                  ...
                  return InkWell(
                    ...
                    child: ClipRRect(borderRadius: BorderRadius.circular(10),
                      child: Container( decoration: BoxDecoration(color: Colors.white,border: Border(bottom: BorderSide(color: Colors.grey.shade300 ),left: BorderSide(color: Colors.grey.shade300 ))),
                        child: Column(
                          ...
                          children: [
                            Expanded(
                              ...
                              child: ClipRRect(
                                ...
                                child: Container(
                                  color: Colors.white,
                                  child: CachedNetworkImage(errorWidget: (c,w,e){
                                    ///TODO: change this to something else default
                                    return Image.asset("assets/men.png",);
                                  },
                                    imageUrl:
