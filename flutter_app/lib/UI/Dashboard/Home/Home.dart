...
class _HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Consumer(
        builder: (context, AppErrorBloc value, child) {
                  ...
                  FutureBuilder<List<Response>>(
                    ...
                    builder: (c, s) {
                      ...
                      if (response1 == null && response2 == null)
                        return Center(
                            child:
                                Text(response2?.data?.toString() ?? "Loading"));
                      else {
                        ...
                        bool topSmallBanner =
                            (resp1Data['small_banner'] as int).toBool() ??
                                false;
                        bool best =
                            (resp1Data['best'] as int).toBool() ?? false;
                        bool topRated =
                        ...
                        bool bottomSmall =
                            (resp1Data['bottom_small'] as int).toBool() ??
                                false;
                        bool flashDeal =
                        ...
                        bool largeBanner =
                            (resp2Data['large_banner'] as int).toBool() ??
                                false;
                        bool bottomSmallBanner =
                            (resp2Data['small_banner'] as int).toBool() ??
                                false;

                        List largeBannersData =
                            resp2Data['large_banners'] ?? [];
                          ...
                          slivers: [
                            ...
                            if (topSmallBanner)
                              Sliders(
                                height: 250,
                                duration:
                                    Duration(milliseconds: 500, seconds: 3),
