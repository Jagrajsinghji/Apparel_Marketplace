...
class ProductGridWIthThumbnail extends StatefulWidget {
  ...
  const ProductGridWIthThumbnail({Key key, this.productData, this.title}) : super(key: key);

  @override
  _ProductGridWIthThumbnailState createState() => _ProductGridWIthThumbnailState();
}
